...
<form enctype="multipart/form-data" onsubmit="return checkValidate(this);"
	method="post" name="writeFrm" action="../space/photoCtrl">
...
<div class="row text-center" style="">
	...
	<button type="button" class="btn btn-warning">
		<a href="/space/list_ctrl?menu=${menu }&flag=${flag }&nowPage=${param.nowpage }&searchColumn=${param.searchColumn }&searchWord=${param.searchWord }">
		리스트보기
		</a>
	</button>
</div>
