...
String pw = session.getAttribute("USER_PW").toString();
//작성자 이름을 가져오기 위한 연결
...
<form enctype="multipart/form-data" onsubmit="return checkValidate(this);"
	method="post" name="writeFrm" action="../space/photoCtrl?menu=<%=menu%>&flag=<%=flag%>">
	...
	<tbody>
		...
		<input type="hidden" name="style" value="write" />
		<tr>
...
<div class="row text-center" style="">
	...
	<button type="button" class="btn btn-warning" 
		onclick="location.href='sub04.jsp?menu=space&flag=04&nowPage=${param.nowpage }&searchColumn=${param.searchColumn }&searchWord=${param.searchWord }';">
		리스트보기</button>
</div>
</form> 
				</div>
