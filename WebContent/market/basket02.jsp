...
$(document).ready(function () {
	$.ajax({
		...
		success : function(d) {
			console.log("성공"+d);
			alert("성공"+d);
			//1.hidden으로 생성된 totalPrice의 값을 숫자형으로 변경
...
<%-- 						</c:choose> --%>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="con_table" style="width:100%;" style="margin-bottom:30px;">
					...
					<tbody>
						<tr>
							<th>결제금액</th>
							<td style="text-align:left;"><span class="money" id="totalPrice">총합</span></td>
						</tr>
						<tr>
							<th>결제방식선택</th>
