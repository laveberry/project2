	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form action="join02.jsp"  onsubmit="return checkAgree();">
					<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agree" value="F">이용약관과 개인정보취급방침에 동의합니다.</p>
				...
				<script>
					function checkAgree() {
						...
						if(ck[0].checked ==false){
							...
							ck[0].value = "T";
							//form만들어서 value값 T 일때만 02로 넘어가게 파라미터 설정하기★★★★★★★★★★★★★★★★★
